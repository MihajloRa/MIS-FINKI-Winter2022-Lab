...
class _CreateNewAppointmentState extends State<CreateNewAppointment> {
  ...
  Future<AppointmentModel?> _submitData() async {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<AppointmentBloc, AppointmentListState>(
      listener: (context, state) {
        if (state is AppointmentAdded || state is AppointmentAlreadyExists) {
        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  AppointmentModel? newAppointment = await _submitData();
